...
Updated deprecated functions to eliminate warnings.

= Version 1.3 =

* **New:** Added Genesis Footer Builder import / export settings to Genesis Import / Export screen to allow users to import and export the plugin settings.
...
This version adds the ability to import / export the plugin settings using Genesis Import / Export screen. Added compatibility with WP 4.5.
