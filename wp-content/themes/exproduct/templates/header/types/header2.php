				...
				<div class="header-topbarbox-1">
					<ul>
						<?php if ($exproduct_header['header_email']) : ?>
							<li><?php esc_html_e('E-mail:', 'exproduct') ?> <?php echo wp_kses_post(exproduct_get_option('header_email', '')) ?></li>
						<?php endif; ?>
					</ul>
				</div>
				...
				<?php if (class_exists('WooCommerce') && $exproduct_header['header_minicart']) : ?>
					<div class="header-navibox-4">
						<div class="header-cart">
							<a href="<?php echo wc_get_cart_url(); ?>"><i class="flaticon-shoppin"></i></a>
		...
		<div class="header-navibox-2">
			<div class="container">
				...
				<?php if ($exproduct_header['header_phone']) : ?>
					<ul class="phone-menu"><li class="no-hover"><?php esc_html_e('call us', 'exproduct') ?> <?php echo wp_kses_post(exproduct_get_option('header_phone', '')) ?></li></ul>
				<?php endif; ?>
			</div>
